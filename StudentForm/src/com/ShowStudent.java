	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (rst.next()) {
				...
				out.print("<td><a href=Update.html?Id="+Id+"&firstName="+firstName+"&lastName="+lastName+"&fatherName="+fatherName+"&email="+email+"&studentClass="+studentClass+"&age="+age+">update</a></td>");
				out.print("</tr>");
			}
