...
public class ProjectController {
	...
	/**
	 * 
	 * @return prices of product in integer Array 
	 */
	 ...
	 * verify quantity and product id is correct or not 
	...
	public String addProductInBucket(){
		...
		if (!(productID <= getSizeOfProductList())) {
			...
			if (!(productQuantity > minProductQuantity)) {
				...
				return "\nAt a time you can buy 100 or less products\n";
			} 
			else {
	...
	/**
	 * Place the order and display price and quantity
	...
	/**
	 * Ask user He want to buy more products or not
